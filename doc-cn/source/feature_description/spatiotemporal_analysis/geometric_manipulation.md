...
* **参数：**  
  ...
  \- `min_x` 为浮点型的 pandas.Series，表示矩形横坐标的最小值。

  \- `min_y` 为浮点型的 pandas.Series，表示矩形纵坐标的最小值。

  \- `max_x` 为浮点型的 pandas.Series，表示矩形横坐标的最大值。

  \- `max_y` 为浮点型的 pandas.Series，表示矩形纵坐标的最大值。

  \- `crs` （可选参数）为字符串，比如“ESPG:4326”、“ESPG:3857”。
...
* **参数：**  
  ...
  \- `x` 为浮点型的 pandas.Series，表示一组点的横坐标。

  \- `y` 为浮点型的 pandas.Series，表示一组点的纵坐标。
