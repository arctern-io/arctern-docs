...
现在，我们已经实现了一种有效的多线程 GeoSeries 数据结构，并且正在开发它的分布式版本。在最新的 0.2.0 版本中，Arctern 的处理速度比 GeoPandas 快 24 倍。即使在单线程执行时，Arctern 的平均性能也要优于 GeoPandas 7 倍。详细的评估结果如下图所示：

.. image:: ./img/performance_geopandas_vs_arctern.png
