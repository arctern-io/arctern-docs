...
在 Arctern-Spark 运行环境中下载[纽约出租车数据集](https://github.com/zilliztech/arctern-resources/blob/benchmarks/benchmarks/dataset/nyc_taxi/0_2M_nyc_taxi_and_building/0_2M_nyc_taxi_and_building.csv)，该数据集包含2009年纽约市出租车运营记录，各字段的含义如下：
