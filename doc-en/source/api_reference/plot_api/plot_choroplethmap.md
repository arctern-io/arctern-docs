...
**plot.choroplethmap(ax, region_boundaries, weights, bounding_box,
...
- region_boundaries(GeoSeries(dtype: GeoDtype)) -- 所需绘制的多边形轮廓，格式为WKB。
...
# 绘制轮廓图，轮廓的填充颜色根据 input['color_weights'] 在 "#115f9a" ~ "#d0f400" 之间变化
